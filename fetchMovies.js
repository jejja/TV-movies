...
async function run() {
    ...
    for (let i = 1; i < programmes.length; i++) {
        ...
        if (catsLower.includes("series") || catsLower.includes("serie") || catsLower.includes("documentary") || catsLower.includes("nyheter") || catsLower.includes("news") || catsLower.includes("teater")) continue;
